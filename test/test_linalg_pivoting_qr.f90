...
module test_linalg_pivoting_qr
    ...
    subroutine test_pivoting_qr_factorization(tests)
        ...
        call add_test(tests,new_unittest("pivoting_qr_random_s",test_pivoting_qr_random_s))
        call add_test(tests,new_unittest("pivoting_qr_random_d",test_pivoting_qr_random_d))
        call add_test(tests,new_unittest("pivoting_qr_random_c",test_pivoting_qr_random_c))
        call add_test(tests,new_unittest("pivoting_qr_random_z",test_pivoting_qr_random_z))

    end subroutine test_pivoting_qr_factorization

    !> QR factorization of a random matrix
    subroutine test_pivoting_qr_random_s(error)
    ...
    end subroutine test_pivoting_qr_random_s

    subroutine test_pivoting_qr_random_d(error)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine test_pivoting_qr_random_d

    subroutine test_pivoting_qr_random_c(error)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine test_pivoting_qr_random_c

    subroutine test_pivoting_qr_random_z(error)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine test_pivoting_qr_random_z
